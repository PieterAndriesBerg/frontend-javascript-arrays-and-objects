...
const personalDetails = {
  ...
  age: 26,
  dateOfBirth: new Date(1994, 07, 26)
}
...
const productDesc = `Het gaat hier om een ${product.productName} deze waterkoker is gemaakt van ${product.material[0]} en ${product.material[1]}.`;
